package ex4_example;
	...
	public class Algoritem {
		public static void main(String[] a) {
	        ...
	        System.out.println((new StringBuilder("Dist: ")).append(b.getDist()).toString());
	        ArrayList shortestPath = b.getPath();
	        for(int i = 0; i < shortestPath.size(); i++)
	        {
	            System.out.print((new StringBuilder(",")).append((String)shortestPath.get(i)).toString());
	        }
